...
class Bucket
{
    ...
    public $headerScripts, $headerStyles, $headerStylesheets, $initFooterScripts, $footerScripts, $executeFooterScripts;
    ...
    public function getFooterExcuteScripts()
    {
    }
